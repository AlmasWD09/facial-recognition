"use client";
import { LocationFieldIcon, PhoneIpfIcon, UserInfIcon } from "@/src/components/icon";
import CustomButton from "@/src/components/resuable/customButton/customButton";
import { FromInput } from "@/src/components/resuable/form-input";
import Form from "@/src/components/resuable/from";
import Faq from "@/src/components/settings/faq";
import PrivacyPolicy from "@/src/components/settings/privacy-policy";
import TermsAndCondition from "@/src/components/settings/terms-and-condition";
import ProfileSkeleton from "@/src/components/shared/dateFormate/sleleton/settings/ProfileSkeleton";
import { db_profile_info_sc } from "@/src/lib/schema";
